...
Doorkeeper.configure do
  ...
  resource_owner_authenticator do
    ...
    current_customerinfo || warden.authenticate!(params[:email], params[:password])
  end

  resource_owner_from_credentials do |routes|
    Customerinfo.authenticate(params[:email], params[:password])
  end
  ...
  admin_authenticator do |_routes|
    current_customerinfo || warden.authenticate!(scope: :customerinfo)
  end
